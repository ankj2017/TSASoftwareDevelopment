...
System.out.println("-------------------------------------");
//row 5
System.out.println(board[3][0] + " | " + board[3][1] + " | " +
board[3][2] + " | " + board[3][3] + " | " + board[3][4] + " | " + board[3][5] + " | " + board[3][6] +
" | " + board[3][7] + " | " + board[3][8] + " | " + board[3][9]);
System.out.println("-------------------------------------");
//row 6
System.out.println(board[4][0] + " | " + board[4][1] + " | " +
board[4][2] + " | " + board[4][3] + " | " + board[4][4] + " | " + board[4][5] + " | " + board[4][6] +
" | " + board[4][7] + " | " + board[4][8] + " | " + board[4][9]);
System.out.println("-------------------------------------");
//row 7
System.out.println(board[5][0] + " | " + board[5][1] + " | " +
board[5][2] +
" | " + board[5][3] + " | " + board[5][4] + " | " + board[5][5] + " | " + board[5][6] +
" | " + board[5][7] + " | " + board[5][8] + " | " + board[5][9]);
System.out.println("-------------------------------------");
//row 7
System.out.println(board[6][0] + " | " + board[6][1] + " | " +
board[6][2] +
...
System.out.println(board[7][0] + " | " + board[7][1] + " | " +
board[7][2] +
" | " + board[7][3] + " | " + board[7][4] + " | " + board[7][5] + " | " + board[7][6] +
" | " + board[7][7] + " | " + board[7][8] + " | " + board[7][9]);
System.out.println("-------------------------------------");
//row 9

System.out.println(board[8][0] + " | " + board[8][1] + " | " +
board[8][2] +
" | " + board[8][3] + " | " + board[8][4] + " | " + board[8][5] + " | " + board[8][6] +
" | " + board[8][7] + " | " + board[8][8] + " | " + board[8][9]);
System.out.println("-------------------------------------");

System.out.println(board[9][0] + " | " + board[9][1] + " | " +
board[9][2] +
" | " + board[9][3] + " | " + board[9][4] + " | " + board[9][5] + " | " + board[9][6] +
" | " + board[9][7] + " | " + board[9][8] + " | " + board[9][9]);
System.out.println("-------------------------------------");

}
public void populateRandomNumbers(int numberOfBoxes)
{
...
switch (randomChoice)
{
case 1: puzzle2 = shuffleBigRow(puzzle2);
case 2: puzzle2 = shuffleBigColumn(puzzle2);
case 3: randomRow = rand.nextInt(9)+1;
puzzle2 = shuffleSmallRow(puzzle2, randomRow);
case 4: randomRow = rand.nextInt(9)+1;
...
public int[][] shuffleBigRow(int[][] puzzle)
{
...
public int[][] shuffleBigColumn(int[][] puzzle)
{
int[][] puzzleShuffle = new int[10][10];
Random rand = new Random();
int random = rand.nextInt(2);
...
public int[][] shuffleSmallRow(int[][] puzzle, int bigRow)
{
int[][] puzzleShuffle = new int[10][10];
Random rand = new Random();
int random = rand.nextInt(2);
...
public int[][] shuffleSmallColumn(int[][] puzzle, int bigColumn)
...
public void changeValue(int row, int column, int number)
{
